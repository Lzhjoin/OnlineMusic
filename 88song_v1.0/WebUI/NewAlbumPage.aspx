<%@ Page Title="" Language="C#" MasterPageFile="~/Music_MasterPage.master" AutoEventWireup="true" CodeFile="NewAlbumPage.aspx.cs" Inherits="NewAlbumPage" %>
<%@ OutputCache CacheProfile="Cache60Seconds" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="Detail_ListBorder">
    <div class="title"><span class="Detail_ListFont">最新专辑</span></div>
    ...
    <%}
      else
      {
        ...
        <span class="Detail_ListName">专辑名称：<a href="DetailAlbumPage.aspx?AlbumID=<%=ds_NewAlbum.Tables[0].Rows[i]["AlbumID"] %>"><%=ds_NewAlbum.Tables[0].Rows[i]["AlbumName"]%></a>-<a href="DetailSingerPage.aspx?SingerID=<%=ds_NewAlbum.Tables[0].Rows[i]["SingerID"]%>"><%=ds_NewAlbum.Tables[0].Rows[i]["SingerName"]%></a></span>
        <span class="Detail_ListName">专辑发布日期：<%=ds_NewAlbum.Tables[0].Rows[i]["PublishDate"]%></span>
        </div>
        <%}
      } %>
    </div>
